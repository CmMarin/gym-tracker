    ...
    <>
      ...
      >
        <div className="flex items-center gap-4">
          ...
          <div className="text-left">
            <h2 className="text-xl font-black text-[var(--color-indigo-500)]">Log Out</h2>
            <p className="text-[var(--color-slate-500)] font-medium text-sm">Sign out of your account</p>
          </div>
        </div>
      </motion.button>
