...
export default function AppLoading() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] p-6 space-y-8 animate-in fade-in duration-300">
      <div className="relative flex items-center justify-center w-28 h-28 bg-blue-500/10 dark:bg-blue-500/20 rounded-[2rem] animate-pulse">
        <Dumbbell className="w-12 h-12 text-blue-500 animate-bounce shadow-blue-500" strokeWidth={2.5} />
      </div>
