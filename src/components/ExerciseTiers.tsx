    ...
    <div className="w-full mb-8">
      ...
      <div className="flex flex-col gap-4">
        {prs.map(pr => {
          ...
          return (
            <div key={pr.name} className="bg-[var(--color-white)] rounded-3xl p-5 border-2 border-[var(--color-indigo-100)] shadow-[0_4px_0_var(--color-indigo-100)] relative overflow-hidden">
              <div className="flex justify-between items-center z-10 relative">
                <span className="font-bold text-[var(--color-slate-800)]">{pr.name}</span>
