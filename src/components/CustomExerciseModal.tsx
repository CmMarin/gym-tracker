        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          ...
          >
            <div className="p-6 border-b border-[var(--color-gray-100)] flex justify-between items-center bg-[var(--color-white)]">
              <h2 className="text-2xl font-black text-[var(--color-slate-800)]">New Exercise</h2>
            ...
            <div className="p-6 space-y-5 overflow-y-auto max-h-[60vh] md:max-h-[70vh] bg-[var(--color-white)]">
              <div>
                <label className="block text-sm font-bold text-[var(--color-slate-500)] mb-2">Exercise Name</label>
                <input 
                  type="text" 
                  value={name} 
              ...
              <div>
                <label className="block text-sm font-bold text-[var(--color-slate-500)] mb-2">Category</label>
                <div className="relative">
                  ...
                  >
                    <option className="bg-[var(--color-white)] text-[var(--color-slate-800)] font-bold" value="Strength">Strength</option>
                    <option className="bg-[var(--color-white)] text-[var(--color-slate-800)] font-bold" value="Cardio">Cardio</option>
                    <option className="bg-[var(--color-white)] text-[var(--color-slate-800)] font-bold" value="Stretching">Stretching</option>
                  </select>
              ...
              <div>
                <label className="block text-sm font-bold text-[var(--color-slate-500)] mb-2">Target Muscles</label>
