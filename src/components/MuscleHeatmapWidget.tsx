...
export default function MuscleHeatmapWidget({
  fatigueData,
}: {
    ...
    <div className="bg-[var(--color-white)] rounded-3xl p-6 shadow-[0_4px_0_var(--color-theme-shadow)] border-2 border-[var(--color-gray-100)] mb-6">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-black text-[var(--color-slate-800)]">
              Muscle Recovery
            </h2>
            <p className="text-sm font-bold text-[var(--color-slate-400)] uppercase tracking-wider">
              Fatigue Heatmap
            </p>
          </div>
        </div>
