...
export default function FriendActivityWidget({ activities }: { activities: FriendActivity[] }) {
  ...
  return (
    <motion.div
      ...
      className="w-full max-w-md bg-white rounded-3xl p-6 shadow-[0_4px_0_theme(colors.gray.200)] border-2 border-gray-100 mb-6"
    >
        ...
        <AnimatePresence>
          {activities.map((act, i) => (
            <motion.div
              ...
              className="flex items-center gap-3 bg-gray-50 border-2 border-gray-100 p-4 rounded-2xl"
            >
