...
export default function BodyWeightTracker({
  ...
  return (
    <div className="w-full max-w-md bg-[var(--color-white)] rounded-3xl p-6 shadow-[0_4px_0_var(--color-theme-shadow)] border-2 border-indigo-50 mb-8">
      ...
      <div className="flex gap-2 mb-6">
        ...
        <button
          onClick={handleAdd}
          disabled={loading}
          className="bg-indigo-500 hover:opacity-90 text-[var(--color-white)] p-3 rounded-2xl font-bold shadow-[0_4px_0_var(--color-button-shadow)] active:shadow-none active:translate-y-1 transition-all"
        >
          <Plus size={24} />
        </button>
      </div>
